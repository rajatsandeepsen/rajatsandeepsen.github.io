...
export const TweetSkeleton = ({
    ...
    <div
        className={cn(
            "flex size-full max-h-max min-w-72 flex-col gap-2 rounded-lg border p-1",
            className,
        )}
        {...props}
    >
...
export const TweetNotFound = ({
    ...
    <div
        className={cn(
            "flex size-full flex-col items-center justify-center gap-2 rounded-lg border p-1",
            className,
        )}
        {...props}
    >
...
export const TweetMedia = ({ tweet }: { tweet: EnrichedTweet }) => {
    ...
    return (
        <div className="flex flex-1 items-center justify-center">
            ...
            {tweet.photos && (
                <div className="relative flex transform-gpu snap-x snap-mandatory gap-4">
